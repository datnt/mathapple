Mathapple::Application.routes.draw do
  ...
  resources :app_managers do
    collection do
      get  :danh_muc, :mucluc, :reception, :lambai, :tiep_theo, :ketthuc, :review, :da_lam_roi, :lamlai, :xoa_ketqua
      post :xulymahs, :newhs, :luu_traloi
    end
  end
  resources :bai_taps do
    collection do
      get :cau_hoi, :cac_cau_hoi, :bai_thi, :them_cau_hoi, :form_cau_hoi, :xoa_cau_hoi
